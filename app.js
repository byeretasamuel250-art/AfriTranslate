...
// 2. Converts it to high-contrast black and white - real OCR tools do
//    this because shadows, lighting, and color tints in a raw photo
//    confuse text recognition. Plain grayscale isn't enough on its own.
function resizeImageForOCR(file, maxDimension = 2200) {
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      // Convert to grayscale, then push each pixel toward pure black or
      // pure white based on a brightness threshold - this makes text
      // stand out sharply from its background, which is what OCR relies on.
