...
// Sunbird only translates between English and these 5 local languages.
// It does NOT support Swahili or Kinyarwanda - those need Google Translate later.
const SUNBIRD_LANGS = ["eng", "lug", "ach", "teo", "lgg", "nyn"];
