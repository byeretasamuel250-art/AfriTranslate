...
// Same limitation as voice input: the browser's free built-in "speak"
// feature only handles major world languages well. Works for English
// and Swahili. Local languages (Luganda, Runyankole, etc.) will need
// Sunbird's own voice service as a later step - browsers can't speak
// those languages at all.
...
speakBtn.addEventListener("click", () => {
  ...
  const langCode = VOICE_OUTPUT_LANGS[tgtLang.value];
  if (!langCode) {
  ...
  if (!window.speechSynthesis) {
    showMessage("Playback isn't supported in this browser.");
    return;
  }

  // Stop anything currently playing before starting new playback.
