...
// Sunbird's new /tasks/translate endpoint covers all these languages directly,
// including Swahili and Kinyarwanda - no need for Google Translate for now.
const SUNBIRD_LANGS = ["eng", "lug", "ach", "teo", "lgg", "nyn", "swa", "kin"];
...
// Voice input (mic button) - placeholder for now
micBtn.addEventListener("click", () => {
  inputText.placeholder = "Voice input coming in a later step...";
});
