...
// Kept so the "Copy all phone numbers" button always has the exact same
// list currently on screen, without re-fetching or re-deriving it from
// the DOM (which would mean re-parsing text back out of table cells).
let currentUsers = [];
